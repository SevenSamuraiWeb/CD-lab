...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_while_loop = 21,                /* while_loop  */
  YYSYMBOL_22_1 = 22,                      /* $@1  */
  YYSYMBOL_23_2 = 23,                      /* $@2  */
...
{
       0,    46,    46,    51,    52,    55,    56,    57,    58,    63,
      70,    62,    94,   104,   113,   118,   123,   128,   133,   137,
     141
};
#endif
...
static const char *const yytname[] =
{
  ...
  "while_loop", "$@1", "$@2", "condition", "assignment", "expr", YY_NULLPTR
};
...
{
      -9,     9,    21,    -9,     7,    -1,    -9,    -9,    25,    -9,
      -9,    12,    42,    -9,    25,     8,    -9,    31,    -9,    25,
      25,    25,    25,    -9,    -6,    25,    -9,    22,    22,    -9,
      -9,    17,    38,    -9,    25,    20,    -6,    -9,     4,    -9
};
...
{
       3,     0,     0,     1,     0,    19,    20,     9,     0,     4,
       6,     0,     0,     8,     0,     0,    19,     0,     5,     0,
       0,     0,     0,     7,    13,     0,    18,    14,    15,    16,
      17,     0,     0,    10,     0,     0,    12,     3,     0,    11
};
...
{
      17,    19,    20,    21,    22,     4,    24,     5,     6,     3,
       7,    27,    28,    29,    30,    14,     8,    32,    13,    39,
      25,    -2,     4,    18,     5,     6,    36,     7,    16,     6,
      33,    21,    22,     8,    37,    38,     0,     8,    19,    20,
      21,    22,     0,    34,    26,    19,    20,    21,    22,    19,
      20,    21,    22,    23
};

static const yytype_int8 yycheck[] =
{
       8,     7,     8,     9,    10,     1,    14,     3,     4,     0,
       6,    19,    20,    21,    22,    16,    12,    25,    11,    15,
      12,     0,     1,    11,     3,     4,    34,     6,     3,     4,
      13,     9,    10,    12,    14,    37,    -1,    12,     7,     8,
       9,    10,    -1,     5,    13,     7,     8,     9,    10,     7,
       8,     9,    10,    11
};
...
{
       0,    18,    19,     0,     1,     3,     4,     6,    12,    20,
      21,    25,    26,    11,    16,    22,     3,    26,    11,     7,
       8,     9,    10,    11,    26,    12,    13,    26,    26,    26,
      26,    24,    26,    13,     5,    23,    26,    14,    19,    15
};

/* YYR1[RULE-NUM] -- Symbol kind of the left-hand side of rule RULE-NUM.  */
static const yytype_int8 yyr1[] =
{
       0,    17,    18,    19,    19,    20,    20,    20,    20,    22,
      23,    21,    24,    25,    26,    26,    26,    26,    26,    26,
      26
};
...
#line 57 "9a.y"
                    { gen_tac("print", (yyvsp[-1].sval), NULL, NULL); /* For testing */ }
#line 1190 "y.tab.c"
    break;
...
#line 1224 "y.tab.c"
  ...
  case 11: /* while_loop: WHILE $@1 '(' condition ')' $@2 '{' statements '}'  */
#line 83 "9a.y"
            {
                /* Marker 3: After body */
...
#line 1237 "y.tab.c"
  ...
  case 12: /* condition: expr RELOP expr  */
#line 95 "9a.y"
           {
               /* Create a new temp to hold the boolean result */
               (yyval.sval) = new_temp();
               /* Generate TAC for the comparison (e.g., t0 = a < b) */
               gen_tac((yyval.sval), (yyvsp[-2].sval), (yyvsp[0].sval), (yyvsp[-1].sval));
           }
#line 1248 "y.tab.c"
    break;
...
#line 105 "9a.y"
            {
                ...
                gen_tac((yyvsp[-2].sval), (yyvsp[0].sval), NULL, "=");
...
#line 114 "9a.y"
      {
          (yyval.sval) = new_temp();
          gen_tac((yyval.sval), (yyvsp[-2].sval), (yyvsp[0].sval), "+"); /* e.g., t0 = t1 + t2 */
      }
#line 1267 "y.tab.c"
    break;
...
#line 119 "9a.y"
      {
          (yyval.sval) = new_temp();
          gen_tac((yyval.sval), (yyvsp[-2].sval), (yyvsp[0].sval), "-");
      }
#line 1276 "y.tab.c"
    break;
...
#line 134 "9a.y"
      {
          (yyval.sval) = (yyvsp[-1].sval); /* No new code, just pass the result up */
      }
#line 1302 "y.tab.c"
    break;
...
#line 138 "9a.y"
      {
          (yyval.sval) = (yyvsp[0].sval); /* The "value" is the variable name itself */
      }
#line 1310 "y.tab.c"
    break;
...
#line 142 "9a.y"
      {
          (yyval.sval) = (yyvsp[0].sval); /* The "value" is the number string */
      }
#line 1318 "y.tab.c"
    break;
